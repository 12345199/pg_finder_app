...
public class RegisterPG extends AppCompatActivity {
    ...
    String reqStoragePerm[] = new String[]{Manifest.permission.READ_EXTERNAL_STORAGE};
                ...
                databaseref.child(Constants.PGDetails).addChildEventListener(new ChildEventListener() {
                    ...
                    public void onChildAdded(@NonNull com.google.firebase.database.DataSnapshot dataSnapshot, @Nullable String previousChildName) {
                        if (dataSnapshot.child("id").getValue().equals(pgIdForEditing)) {
                            ...
                            String childname = "PgImages/" + pgDetails.getPgImageOne();
                            imageDownloadRef.child(childname).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                @Override
                                public void onSuccess(Uri uri) {
                                    Picasso.with(getApplicationContext()).load(uri).fit().into(imgUpload_1);
                                }
...
//                Toast.makeText(ctx, "Failed To Upload The Image!", Toast.LENGTH_SHORT).show();
                            ...
                            String childname2 = "PgImages/" + pgDetails.getPgImageTwo();
                            imageDownloadRef.child(childname2).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                @Override
                                public void onSuccess(Uri uri) {
                                    Picasso.with(getApplicationContext()).load(uri).fit().into(imgUpload_2);
                                }
                            }).addOnFailureListener(new OnFailureListener() {
                                @Override
                                public void onFailure(@NonNull Exception e) {
//                Toast.makeText(ctx, "Failed To Upload The Image!", Toast.LENGTH_SHORT).show();
                            ...
                            String childname3 = "PgImages/" + pgDetails.getPgImageThree();
                            imageDownloadRef.child(childname3).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                @Override
                                public void onSuccess(Uri uri) {
                                    Picasso.with(getApplicationContext()).load(uri).fit().into(imgUpload_3);
                                }
                            }).addOnFailureListener(new OnFailureListener() {
                                @Override
                                public void onFailure(@NonNull Exception e) {
//                Toast.makeText(ctx, "Failed To Upload The Image!", Toast.LENGTH_SHORT).show();
                            ...
                            String childname4 = "PgImages/" + pgDetails.getPgImageFour();
                            imageDownloadRef.child(childname4).getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                @Override
                                public void onSuccess(Uri uri) {
                                    Picasso.with(getApplicationContext()).load(uri).fit().into(imgUpload_4);
                                }
                            }).addOnFailureListener(new OnFailureListener() {
                                @Override
                                public void onFailure(@NonNull Exception e) {
//                Toast.makeText(ctx, "Failed To Upload The Image!", Toast.LENGTH_SHORT).show();
                            ...
                            name1 = pgDetails.getPgImageOne();
                            name2 = pgDetails.getPgImageTwo();
                            name3 = pgDetails.getPgImageThree();
                            name4 = pgDetails.getPgImageFour();
                            ...
                            cancelImage1.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    String childname = "PgImages/" + pgDetails.getPgImageOne();
                                    imageDownloadRef.child(childname).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                        @Override
                            ...
                            cancelImage2.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    String childname = "PgImages/" + pgDetails.getPgImageTwo();
                                    imageDownloadRef.child(childname).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                        @Override
                                        public void onSuccess(Void aVoid) {
                                            Log.d(TAG, "onSuccess: IMAGE DELETED SUCCESSFULLY");
                            ...
                            cancelImage3.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    String childname = "PgImages/" + pgDetails.getPgImageThree();
                                    imageDownloadRef.child(childname).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                        @Override
                                        public void onSuccess(Void aVoid) {
                                            Log.d(TAG, "onSuccess: IMAGE DELETED SUCCESSFULLY");
                            ...
                            cancelImage4.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    String childname = "PgImages/" + pgDetails.getPgImageFour();
                                    imageDownloadRef.child(childname).delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                        @Override
                                        public void onSuccess(Void aVoid) {
                                            Log.d(TAG, "onSuccess: IMAGE DELETED SUCCESSFULLY");
            ...
            public void onClick(View v) {
                ...
                if (cuwbp.downloadUrl1 != null && cuwbp.downloadUrl2 != null &&
                  ...
                  /*  image1 = (cuwbp.downloadUrl1).toString();
                    ...
                    image1 = (cuwbp.imagename1).toString();
                    image2 = (cuwbp.imagename2).toString();
                    image3 = (cuwbp.imagename3).toString();
                    image4 = (cuwbp.imagename4).toString();
...
//******************************************* SENDING THE DETAILS TO THE FIREBASE DATABASE****************************************
                    ...
                    PgDetails_POJO.PgDetails pgDetails = new PgDetails_POJO.PgDetails(PgId, bun.getString("pgName"), bun.getString("ownerName"),
                            Long.parseLong(bun.getString("contactNo")), bun.getString("email"),
                    ...
                    //For Second Database
                    PgDetails_POJO.PgDetails nameDatabase  = new PgDetails_POJO.PgDetails(bun.getString("ownerName"), Long.parseLong(bun.getString("contactNo")));


                    //UPDATING THE PG
                    if (RegisterPGPageOne.editCalledFlag == 2990) {
                        Log.d(TAG, "onClick: ####### KEY 1 #######" + key);
                        databaseref.child(Constants.PGDetails).child(key).setValue(pgDetails);
                    ...
                    else
                    {
                        ...
                        databaseref.child(Constants.PGDetails).push().setValue(pgDetails);
                        databaseref.child("NameDatabase").push().setValue(nameDatabase);
...
//******************************************* SENDING THE DETAILS TO THE FIREBASE DATABASE****************************************
    ...
    public void uploadImage(Uri downloadUrl, final int imageNumber) {
        ...
        FirebaseStorage storage = FirebaseStorage.getInstance();
        storageRef = storage.getReferenceFromUrl("gs://pgfinder-90d67.appspot.com");

        StorageReference imagesRef = storageRef.child("PgImages").child(imgname);
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                   ...
                   // Uri downloadUrl = taskSnapshot.getDownloadUrl();
                    ...
                    if (imageNumber == 1){
                        ...
                        cuwbp.imagename1 = imgname;
                    }
                    if (imageNumber == 2)
                    {
                        cuwbp.downloadUrl2 = downloadUrl;
                        cuwbp.imagename2 = imgname;
                    }

                    if (imageNumber == 3)
                    {
                        cuwbp.downloadUrl3 = downloadUrl;
                        cuwbp.imagename3 = imgname;
                    }
    ...
    public class callUploadWhenBtnPressed {
        ...
        String imagename1,imagename2,imagename3,imagename4;
    }
